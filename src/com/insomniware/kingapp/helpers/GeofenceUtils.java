...
public final class GeofenceUtils {
    ...
    public static final String EXTRA_CONNECTION_ERROR_CODE =
            "com.insomniware.kingapp.EXTRA_CONNECTION_ERROR_CODE";

    public static final String EXTRA_CONNECTION_ERROR_MESSAGE =
            "com.insomniware.kingapp.EXTRA_CONNECTION_ERROR_MESSAGE";

    public static final String EXTRA_GEOFENCE_STATUS =
            "com.insomniware.kingapp.EXTRA_GEOFENCE_STATUS";

    /*
     * Keys for flattened geofences stored in SharedPreferences
     */
    public static final String KEY_LATITUDE = "com.insomniware.kingapp.KEY_LATITUDE";

    public static final String KEY_LONGITUDE = "com.insomniware.kingapp.KEY_LONGITUDE";

    public static final String KEY_RADIUS = "com.insomniware.kingapp.KEY_RADIUS";

    public static final String KEY_EXPIRATION_DURATION =
            "com.insomniware.kingapp.KEY_EXPIRATION_DURATION";

    public static final String KEY_TRANSITION_TYPE =
            "com.insomniware.kingapp.KEY_TRANSITION_TYPE";

    // The prefix for flattened geofence keys
    public static final String KEY_PREFIX =
            "com.insomniware.kingapp.KEY";
